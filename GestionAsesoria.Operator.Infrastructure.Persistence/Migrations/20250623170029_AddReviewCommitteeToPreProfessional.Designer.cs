...
namespace GestionAsesoria.Operator.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250623170029_AddReviewCommitteeToPreProfessional")]
    partial class AddReviewCommitteeToPreProfessional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionAsesoria.Operator.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<int>("AdvisorActorId")
                        .HasColumnType("int")
                        .HasComment("Actor que recibe la cita (Docente/Asesor)");

                    b.Property<int>("AppointmentTypeId")
                        .HasColumnType("int")
                        .HasComment("Tipo de cita desde MasterDataValue (Tesis, PPP, Tutoría, etc.)");

                    b.Property<int>("CurrentAppointmentStatusId")
                        .HasColumnType("int")
                        .HasComment("Estado actual de la cita");

                    b.Property<DateTime>("DateTime")
                        .HasColumnType("datetime2")
                        .HasComment("Fecha y hora de la cita");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Descripción de la cita");

                    b.Property<string>("GoogleEventId")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("ID del evento en Google Calendar para sincronización");

                    b.Property<string>("Location")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Ubicación de la cita (física o virtual)");

                    b.Property<string>("MeetingLink")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Enlace de reunión virtual (Google Meet, Zoom, etc.)");

                    b.Property<string>("Notes")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Información adicional sobre la cita");

                    b.Property<int>("StudentActorId")
                        .HasColumnType("int")
                        .HasComment("Actor que agenda la cita (Estudiante)");

                    b.Property<string>("TimeZone")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Zona horaria de la cita");

                    b.Property<string>("Title")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Título de la cita");
            ...
            modelBuilder.Entity("GestionAsesoria.Operator.Domain.Entities.RequestPPP", b =>
                {
                    ...
                    b.Property<int>("CompanyId")
                        .HasColumnType("int")
                        .HasComment("ID de la empresa donde se realizarán las prácticas.");

                    b.Property<int>("CompanyRepresentativeId")
                        .HasColumnType("int")
                        .HasComment("ID del representante asignado por la empresa.");
                    ...
                    b.Property<int>("RepresentativeId")
                        .HasColumnType("int")
                        .HasComment("ID del representante legal de la empresa.");
                    ...
                    b.Property<int>("StatusId")
                        .HasColumnType("int")
                        .HasComment("ID del estado actual de la solicitud.");

                    b.Property<int>("StudentId")
                        .HasColumnType("int")
                        .HasComment("ID del estudiante solicitante.");
                    ...
                    b.ToTable("RequestPPP", null, t =>
                        {
                            t.HasComment("Representa una solicitud de prácticas pre profesionales realizada por un estudiante.");
                        });
                });
            ...
            modelBuilder.Entity("GestionAsesoria.Operator.Domain.Entities.RequestPPP", b =>
                {
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.Actor", "Company")
                        .WithMany()
                    ...
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.Actor", "CompanyRepresentative")
                        .WithMany()
                    ...
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.Actor", "Representative")
                        .WithMany()
                    ...
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.Actor", "ResearchArea")
                        .WithMany()
                        .HasForeignKey("ResearchAreaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.MasterDataValue", "Status")
                        .WithMany()
                    ...
                    b.HasOne("GestionAsesoria.Operator.Domain.Entities.Actor", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
