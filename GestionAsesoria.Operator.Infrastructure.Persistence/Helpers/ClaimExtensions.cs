...
namespace GestionAsesoria.Operator.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<AcademicRole> roleManager, AcademicRole role, string permission)
        {
