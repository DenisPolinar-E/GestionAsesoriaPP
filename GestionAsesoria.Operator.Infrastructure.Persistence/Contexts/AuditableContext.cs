...
namespace GestionAsesoria.Operator.Infrastructure.Contexts
{
    public abstract class AuditableContext : IdentityDbContext<AcademicUser, AcademicRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, AcademicRoleClaim, IdentityUserToken<string>>
    {
